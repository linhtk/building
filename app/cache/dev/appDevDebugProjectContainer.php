...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'essensys.demo.listener' => 'getEssensys_Demo_ListenerService',
            ...
            'twig.extension.essensys.demo' => 'getTwig_Extension_Essensys_DemoService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/XAMP/htdocs/Symfony/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('D:/XAMP/htdocs/Symfony/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'D:/XAMP/htdocs/Symfony/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'D:/XAMP/htdocs/Symfony/app/Resources');
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.controller', array(0 => 'essensys.demo.listener', 1 => 'onKernelController'), 0);
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_55ee7bc2ba2396b55dce463a361b8967ceac832813e49d29afceb7e2f85d3a56');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_55ee7bc2ba2396b55dce463a361b8967ceac832813e49d29afceb7e2f85d3a56');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_55ee7bc2ba2396b55dce463a361b8967ceac832813e49d29afceb7e2f85d3a56');
        ...
        $d->setProxyDir('D:/XAMP/htdocs/Symfony/app/cache/dev/doctrine/orm/Proxies');
    ...
    /**
     * Gets the 'essensys.demo.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Essensys\DemoBundle\EventListener\ControllerListener A Essensys\DemoBundle\EventListener\ControllerListener instance.
     */
    protected function getEssensys_Demo_ListenerService()
    {
        return $this->services['essensys.demo.listener'] = new \Essensys\DemoBundle\EventListener\ControllerListener($this->get('twig.extension.essensys.demo'));
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'D:/XAMP/htdocs/Symfony/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('D:/XAMP/htdocs/Symfony/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:D:/XAMP/htdocs/Symfony/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'D:/XAMP/htdocs/Symfony/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'D:/XAMP/htdocs/Symfony/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/XAMP/htdocs/Symfony/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('D:/XAMP/htdocs/Symfony/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/XAMP/htdocs/Symfony/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'D:/XAMP/htdocs/Symfony/app', 'UTF-8');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'D:/XAMP/htdocs/Symfony/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'D:/XAMP/htdocs/Symfony/app', 'UTF-8'));
        ...
        $instance->addExtension($this->get('twig.extension.essensys.demo'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('D:\\XAMP\\htdocs\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('D:\\XAMP\\htdocs\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('D:\\XAMP\\htdocs\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('D:\\XAMP\\htdocs\\Symfony\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('D:\\XAMP\\htdocs\\Symfony\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('D:\\XAMP\\htdocs\\Symfony\\src\\Essensys\\DemoBundle/Resources/views', 'EssensysDemo');
        $instance->addPath('D:\\XAMP\\htdocs\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('D:\\XAMP\\htdocs\\Symfony\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('D:/XAMP/htdocs/Symfony/app/Resources/views');
        $instance->addPath('D:\\XAMP\\htdocs\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/XAMP/htdocs/Symfony/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('D:/XAMP/htdocs/Symfony/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/XAMP/htdocs/Symfony/app/cache/dev');
    }
    ...
    /**
     * Gets the 'twig.extension.essensys.demo' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * make it public, otherwise you might end up with broken code.
     *
     * @return Essensys\DemoBundle\Twig\Extension\DemoExtension A Essensys\DemoBundle\Twig\Extension\DemoExtension instance.
     */
    protected function getTwig_Extension_Essensys_DemoService()
    {
        return $this->services['twig.extension.essensys.demo'] = new \Essensys\DemoBundle\Twig\Extension\DemoExtension($this->get('twig.loader'));
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'D:\\XAMP\\htdocs\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'D:/XAMP/htdocs/Symfony/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/XAMP/htdocs/Symfony/app/cache/dev',
            'kernel.logs_dir' => 'D:/XAMP/htdocs/Symfony/app/logs',
            'kernel.bundles' => array(
                ...
                'EssensysDemoBundle' => 'Essensys\\DemoBundle\\EssensysDemoBundle',
            ...
            'debug.container.dump' => 'D:/XAMP/htdocs/Symfony/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'D:/XAMP/htdocs/Symfony/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'D:\\XAMP\\htdocs\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:D:/XAMP/htdocs/Symfony/app/cache/dev/profiler',
            ...
            'router.resource' => 'D:/XAMP/htdocs/Symfony/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/XAMP/htdocs/Symfony/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/XAMP/htdocs/Symfony/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/XAMP/htdocs/Symfony/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'D:/XAMP/htdocs/Symfony/app/../web',
            'assetic.write_to' => 'D:/XAMP/htdocs/Symfony/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'D:/XAMP/htdocs/Symfony/app/cache/dev/doctrine/orm/Proxies',
